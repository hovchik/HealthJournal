...
class GetVitalSignsByDateRangeUseCase @Inject constructor(
    private val repository: VitalSignRepository
) {
...
class AddVitalSignUseCase @Inject constructor(
    private val repository: VitalSignRepository
) {
    suspend operator fun invoke(vitalSign: VitalSign): Long = repository.insertVitalSign(vitalSign)
}

class DeleteVitalSignUseCase @Inject constructor(
    private val repository: VitalSignRepository
) {
